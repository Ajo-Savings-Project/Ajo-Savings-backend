...
import { getGlobalWallet, resendOTP, updateUser, verifyOTP, withdrawFromUserGroupWallet, withdrawFromUserSavingsWallet} from "../controllers/user-controllers/users-controllers";
import {
...
router.get("/global_wallet", auth, getGlobalWallet)
