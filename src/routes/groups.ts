...
import { addMoneytoTotalGroupSavings, getTotalGroupSaving } from "../controllers/addMoneyToTotalGroupSavings-controllers";
...
// router.post('/create-group',  upload.single("group_image"), createGroup)
...
router.post("/add-money/total-group-savings", auth, addMoneytoTotalGroupSavings)
router.post("/add-money/total-personal-savings/:id", auth, addMoneyToTotalPersonalSavings)
router.get("/totalGroup-saving", auth, getTotalGroupSaving)
router.get("/get-single-group-transactions/:id", auth, getSingleGroupTransactions)
