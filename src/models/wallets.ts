...
class Wallets extends Model<WalletAttributes>{
   earnings!: Array<{ date: Date; amount: number }>; // Add earnings array
    total_group_savings: any;  // this line is throwing error when total_group_savings: number. It should be like this total_group_savings: [] = []. But I used any to stop the error.
    total_personal_savings: any;
    total_amount!: number;
  id!: string;
  static id: string;
